...
public class BuildNativeLib {
    //库名称
    public static final String LABA_NAME = "labaplus";
    ...
    public static class CMakeOptions {
        ...
        public String getCmakeBinaryPath() {
            return new File(getCmakePath(), "cmake").getAbsolutePath();
        }

        public String getNinjaBinaryPath() {
            return new File(getCmakePath(), "ninja").getAbsolutePath();
        }
        ...
        public Map<File, File> getSharedObjectFileMap() {
            ...
            final String vm = "lib" + LABA_NAME + ".so";
